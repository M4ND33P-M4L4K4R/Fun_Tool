...
termux-tts-speak This Script Is Only For Fun
echo -e "     \033[1m+ \033[31m\033[4mThis Script is Only for Fun \033[0m\033[33m+" | pv -qL 12|lolcat -as 200
echo -e "\033[0m"
#Option
...
echo -e "        \033[1m\033[0m[+]\033[7m\033[33m Coded \033[31m By \033[34m Mandeep \033[0m[+]"| pv -qL 8
...
echo
echo -e  "\033[1m\033[32m             Invalid Option Sir !  "| pv -qL 10
echo
fi
